...
const PALETTES = [
  { id:'indigo', label:'Indigo', accent:'#818cf8', soft:'rgba(129,140,248,0.15)', border:'rgba(129,140,248,0.35)',
    accent2:       { dark:'#f59e0b',  light:'#d97706' },
    accent2s:      { dark:'rgba(245,158,11,0.12)', light:'rgba(217,119,6,0.1)' },
    accent2b:      { dark:'rgba(245,158,11,0.28)', light:'rgba(217,119,6,0.22)' },
    accent2glow:   { dark:'rgba(245,158,11,0.15)', light:'rgba(217,119,6,0.1)' },
    accent2dark:   { dark:'#b45309', light:'#92400e' },
    sidebarBg:     { dark:'linear-gradient(165deg, rgba(245,158,11,0.06) 0%, rgba(15,12,28,0.97) 40%)',  light:'linear-gradient(165deg, rgba(217,119,6,0.08) 0%, rgba(255,255,255,0.85) 40%)' },
    sidebarLine:   { dark:'linear-gradient(90deg, transparent, #f59e0b, transparent)', light:'linear-gradient(90deg, transparent, #d97706, transparent)' },
    sidebarItemH:  { dark:'rgba(245,158,11,0.08)', light:'rgba(217,119,6,0.1)' },
  ...
  { id:'cyan', label:'Cyan', accent:'#22d3ee', soft:'rgba(34,211,238,0.15)', border:'rgba(34,211,238,0.35)',
    accent2:       { dark:'#34d399',  light:'#059669' },
    accent2s:      { dark:'rgba(52,211,153,0.12)', light:'rgba(5,150,105,0.1)' },
    accent2b:      { dark:'rgba(52,211,153,0.28)', light:'rgba(5,150,105,0.22)' },
    accent2glow:   { dark:'rgba(52,211,153,0.15)', light:'rgba(5,150,105,0.1)' },
    accent2dark:   { dark:'#047857', light:'#064e3b' },
    sidebarBg:     { dark:'linear-gradient(165deg, rgba(52,211,153,0.06) 0%, rgba(15,12,28,0.97) 40%)',  light:'linear-gradient(165deg, rgba(5,150,105,0.08) 0%, rgba(255,255,255,0.85) 40%)' },
    sidebarLine:   { dark:'linear-gradient(90deg, transparent, #34d399, transparent)', light:'linear-gradient(90deg, transparent, #059669, transparent)' },
    sidebarItemH:  { dark:'rgba(52,211,153,0.08)', light:'rgba(5,150,105,0.1)' },
    sidebarCtaTx:  { dark:'#0f0a1a', light:'#fff' },
  },
  { id:'rose', label:'Rose', accent:'#fb7185', soft:'rgba(251,113,133,0.15)', border:'rgba(251,113,133,0.35)',
    accent2:       { dark:'#fbbf24',  light:'#d97706' },
    accent2s:      { dark:'rgba(251,191,36,0.12)', light:'rgba(217,119,6,0.1)' },
    accent2b:      { dark:'rgba(251,191,36,0.28)', light:'rgba(217,119,6,0.22)' },
    accent2glow:   { dark:'rgba(251,191,36,0.15)', light:'rgba(217,119,6,0.1)' },
    accent2dark:   { dark:'#b45309', light:'#92400e' },
    sidebarBg:     { dark:'linear-gradient(165deg, rgba(251,191,36,0.06) 0%, rgba(15,12,28,0.97) 40%)',  light:'linear-gradient(165deg, rgba(217,119,6,0.08) 0%, rgba(255,255,255,0.85) 40%)' },
    sidebarLine:   { dark:'linear-gradient(90deg, transparent, #fbbf24, transparent)', light:'linear-gradient(90deg, transparent, #d97706, transparent)' },
    sidebarItemH:  { dark:'rgba(251,191,36,0.08)', light:'rgba(217,119,6,0.1)' },
    sidebarCtaTx:  { dark:'#0f0a1a', light:'#fff' },
  },
]
