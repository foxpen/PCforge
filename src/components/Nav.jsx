...
export default function Nav({ theme, onToggleTheme, total, sel, selShop, onShare, onExport }) {
  return (
    <nav className="nav">
      ...
      <div className="nav-right">
        ...
        <button className="theme-btn" onClick={onExport} title="Export">📄</button>
        {total > 0 && (
          <div className="nav-total">
            <span style={{ color: 'var(--text-2)', fontSize: '0.8rem' }}>Sestava</span>
