  ...
  return (
    <>
      ...
      <div className="fixed z-[99999]" style={{top:'1.25rem',left:'1.25rem',transform:achievement?'translateX(0)':'translateX(-120%)',transition:'transform 0.4s cubic-bezier(0.34,1.56,0.64,1)',pointerEvents:achievement?'all':'none'}}>
        {achievement && (
          <div className="relative overflow-hidden rounded-2xl" style={{width:'clamp(260px,22vw,320px)',background:'var(--surface)',border:'1px solid var(--accent-b)',backdropFilter:'blur(40px)',padding:'1.25rem'}}>
            ...
            <div className="h-[3px] rounded-full overflow-hidden relative z-10" style={{background:'var(--surface-2)'}}>
