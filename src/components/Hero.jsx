  ...
  return (
    <>
      <section className="relative z-10 text-center px-[clamp(1.5rem,8vw,12rem)] pt-[clamp(80px,12vh,160px)] pb-[clamp(48px,6vh,80px)]">
        ...
        <h1 className="font-extrabold tracking-tight leading-[1.1] mb-6" style={{fontSize:'clamp(2.2rem,6vw,4.5rem)', color:'var(--tx)'}}>
          Sestav svůj<br />
          počítač <em className="not-italic" style={{color:'var(--accent)'}}>chytře</em>
        </h1>
